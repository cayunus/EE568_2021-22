...
oModule.AssignCoilTerminal Array("NAME:PhA_0", "Objects:=", Array("CoilTerm_0"), _
  "Conductor number:=", 26, "Point out of terminal:=", false, "Winding:=", _
  "PhaseA")
...
oModule.AssignCoilTerminal Array("NAME:PhBRe_2", "Objects:=", Array(_
  "CoilTerm_2"), "Conductor number:=", 26, "Point out of terminal:=", true, _
  "Winding:=", "PhaseB")
...
oModule.AssignCoilTerminal Array("NAME:PhBRe_4", "Objects:=", Array(_
  "CoilTerm_4"), "Conductor number:=", 26, "Point out of terminal:=", true, _
  "Winding:=", "PhaseB")
...
oModule.AssignCoilTerminal Array("NAME:PhBRe_6", "Objects:=", Array(_
  "CoilTerm_6"), "Conductor number:=", 26, "Point out of terminal:=", true, _
  "Winding:=", "PhaseB")
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "Load Torque:=", _
  "if(speed<157.08, -0.0243536*speed, -600.902/speed) - 0.0243536*(speed-157.08)*10", _
  "Objects:=", Array("Band"))
oModule.EditMotionSetup Array("NAME:Data", "Consider Mechanical Transient:=", _
  false)
Set oModule = oDesign.GetModule("AnalysisSetup")
oModule.InsertSetup "Transient", Array("NAME:Setup1", "StopTime:=", "0.04s", _
  "TimeStep:=", "4e-05s")
Set oModule = oDesign.GetModule("BoundarySetup")
...
oModule.CreateOutputVariable "Irms", "sqrt(I_d^2+I_q^2)/sqrt(2)", _
  "Setup1 : Transient", "Transient", Array() 
oModule.CreateOutputVariable "Pcu", "3*Irms^2*0.727761", "Setup1 : Transient", _
  "Transient", Array() 
Set oModule = oDesign.GetModule("ReportSetup")
