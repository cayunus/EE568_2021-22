...
oModule.AssignWindingGroup Array("NAME:PhaseA", "Type:=", "Voltage", _
  ...
  "103.692*sin(2*pi*250*time-9.1999*pi/180)", "Resistance:=", "0.727761ohm", _
  "Inductance:=", "2.21719e-05H", "ParallelBranchesNum:=", "1")
Set oModule = oDesign.GetModule("BoundarySetup")
oModule.AssignWindingGroup Array("NAME:PhaseB", "Type:=", "Voltage", _
  "IsSolid:=", false, "Current:=", "0A", "Voltage:=", _
  "103.692*sin(2*pi*250*time-9.1999*pi/180-2*pi/3)", "Resistance:=", _
  "0.727761ohm", "Inductance:=", "2.21719e-05H", "ParallelBranchesNum:=", "1")
Set oModule = oDesign.GetModule("BoundarySetup")
oModule.AssignWindingGroup Array("NAME:PhaseC", "Type:=", "Voltage", _
  "IsSolid:=", false, "Current:=", "0A", "Voltage:=", _
  "103.692*sin(2*pi*250*time-9.1999*pi/180-4*pi/3)", "Resistance:=", _
  "0.727761ohm", "Inductance:=", "2.21719e-05H", "ParallelBranchesNum:=", "1")
oModule.AssignCoil Array("NAME:PhA_0", "Objects:=", Array("Coil_0"), _
  "Conductor number:=", 26, "PolarityType:=", "Positive", "Winding:=", _
  "PhaseA")
oModule.AssignCoil Array("NAME:PhARe_0", "Objects:=", Array("CoilRe_1"), _
  "Conductor number:=", 26, "PolarityType:=", "Negative", "Winding:=", _
  "PhaseA")
